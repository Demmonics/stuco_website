...
export const LetterGlitch: React.FC<LetterGlitchProps> = ({
  glitchColors = ['#9ca3af', '#e5e7eb', '#4b5563'],
  className = '',
  glitchSpeed = 50,
  ...
  const mixRgb = (start: { r: number; g: number; b: number }, end: { r: number; g: number; b: number }, factor: number) => ({
  ...
  const containerStyle: React.CSSProperties = {
    ...
    width: '100%',
    height: '100%',
    backgroundColor: backgroundColor || (lightMode ? '#ffffff' : '#08090a'),
    overflow: 'hidden'
  };
  ...
  const outerVignetteStyle: React.CSSProperties = {
    ...
    background: lightMode
      ...
      : 'radial-gradient(circle, rgba(8,9,10,0) 55%, rgba(8,9,10,0.96) 100%)'
  };
  ...
  const centerVignetteStyle: React.CSSProperties = {
    ...
    background: lightMode
      ...
      : 'radial-gradient(circle, rgba(8,9,10,0.85) 0%, rgba(8,9,10,0) 60%)'
  };
