...
const resolveFontSize = (value: number | string, container: HTMLElement, fontWeight: string | number, fontFamily: string): number => {
...
export const ParticleText: React.FC<ParticleTextProps> = ({
  ...
  useEffect(() => {
    ...
    const sampleText = async () => {
      ...
      if (reducedMotion || hasInitialGathered) {
        particles.forEach(particle => {
    ...
    const handleReduceMotionChange = (_event: MediaQueryListEvent) => {
      sampleText();
    };
